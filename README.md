# 🚚 Delivery Intelligence & Sequence Analytics
...
```bash
# 1. Feature Preprocessing & Leakage-Free Temporal Splits
python scripts/03_ml_preprocessing.py

# 2. Automated Leakage & Integrity Tests
...
# 5. TreeSHAP & Subgroup Error Analysis
